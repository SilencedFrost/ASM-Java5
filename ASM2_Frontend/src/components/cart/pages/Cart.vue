              ...
              <tbody>
                <tr v-for="item in cartItems" :key="item.id">
                  ...
                  <td class="border-0 py-4 text-center">
                    <span class="fw-bold text-dark">{{ formatPrice(item.price) }}</span>
                  </td>
                  <td class="border-0 py-4">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-8">
                  ...
                  <div class="d-flex justify-content-between align-items-center mb-3">
                    <span class="fw-bold text-secondary">{{ formatPrice(item.price) }}</span>
                    <button class="btn btn-secondary btn-sm" @click="removeItem(item.id)">
                      Xóa
                    </button>
                  </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="d-flex justify-content-between mb-2">
                  ...
                  <span class="fw-bold text-dark">{{ formatPrice(subtotal * 0.1) }}</span>
                </div>
              </div>
              <div class="col-lg-6">
