                        ...
                        <div class="col-md-8">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <div class="form-control bg-light border-0 w-75">phucdeptrai</div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <input type="email" class="form-control me-2 w-75">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <input type="text" class="form-control me-2 w-75">
